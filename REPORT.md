...
| Peak TPM (VU iterations, BP 110G) | 1,226,157 | 1,212,899 | 1,097,938 | 1,252,012 |
| Scaling 10→320 VU (BP 110G) | 3.9× | 4.0× | 4.0× | 3.8× |
...
|----|---|---|---|---|
| 10 | 301,942 | 292,497 | 276,116 | **333,019** |
| 20 | 541,276 | 518,776 | 506,079 | **603,331** |
| 40 | 848,592 | 810,835 | 800,144 | **914,072** |
| 80 | 1,157,551 | 1,107,155 | 1,023,746 | **1,163,664** |
| 160 | 1,226,157 | 1,212,899 | 1,092,135 | **1,226,158** |
| 320 | 1,186,987 | 1,166,107 | 1,097,938 | **1,252,012** |
...
| Config | Engine | Mean TPM | Std Dev | CV% | P5 | P95 | P5-P95 Range |
|--------|--------|-----------|---------|-----|-----|-----|-------------|
| 10 VU | MariaDB 12.2.2 | 302,186 | 13,847 | 4.6% | 279,120 | 318,300 | 39,180 |
...
| 20 VU | MariaDB 12.2.2 | 541,811 | 26,263 | 4.8% | 500,880 | 581,160 | 80,280 |
...
| 40 VU | MariaDB 12.2.2 | 849,380 | 40,668 | 4.8% | 781,980 | 909,600 | 127,620 |
...
| 80 VU | MariaDB 12.2.2 | 1,158,569 | 45,870 | 4.0% | 1,087,080 | 1,204,680 | 117,600 |
...
| 160 VU | MariaDB 12.2.2 | 1,228,908 | 25,099 | 2.0% | 1,203,780 | 1,248,780 | 45,000 |
...
| 320 VU | MariaDB 12.2.2 | 1,194,182 | 16,935 | 1.4% | 1,168,680 | 1,216,980 | 48,300 |
